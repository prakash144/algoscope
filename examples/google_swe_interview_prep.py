...
def analyze_two_sum():
    ...
    results = analyze_functions(
        ...
        html_out="google_swe_two_sum.html",
...
def analyze_max_subarray():
    ...
    results = analyze_functions(
        ...
        normalize_ref_at="max",
        html_out="google_swe_max_subarray.html",
...
def analyze_coin_change():
    ...
    results = analyze_functions(
        ...
        reference_curves=("1", "n", "n**2", "2**n"),
        normalize_ref_at="max",
        html_out="google_swe_coin_change.html",
...
def analyze_word_break():
    ...
    results = analyze_functions(
        ...
        reference_curves=("1", "n", "n**2", "2**n"),
        normalize_ref_at="max",
        html_out="google_swe_word_break.html",
